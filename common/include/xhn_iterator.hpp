...
/**
template <typename T, typename Readproc>
class forward_iterator : public readonly_iterator<T, Readproc>
{};
template <typename T, typename Readproc>
class bidirectional_iterator : public forward_iterator<T, Readproc> {};
template <typename T, typename Readproc>
class random_access_iterator : public bidirectional_iterator<T, Readproc> {};
**/
}
#endif
