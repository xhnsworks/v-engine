...
API_EXPORT vptr _SMalloc(uint _size, const char* _file, uint32 _line);
...
API_EXPORT void* MemAllocator_alloc(MemAllocator _self, uint _size, bool _is_safe_alloc);
API_EXPORT void* MemAllocator_salloc(MemAllocator _self, uint _size);
