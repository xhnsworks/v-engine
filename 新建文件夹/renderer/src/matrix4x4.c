...
void Matrix4x4_mul_matrix4(Matrix4x4 m1, Matrix4x4 m2, Matrix4x4 result)
{
#ifdef USE_SSE
    __m128 temp1, temp2, temp3, temp4,
           temp5, temp6, temp7, temp8,
...
void Matrix4x4_assign(Matrix4x4 _dst, Matrix4x4 _src)
{
#ifdef USE_SSE
    _dst->m0 = _src->m0;
    _dst->m1 = _src->m1;
...
float3 Matrix4x4_get_translate(Matrix4x4 _mat)
{
#ifdef USE_SSE
    return Float3( ((float*)&_mat->m0)[3], ((float*)&_mat->m1)[3], ((float*)&_mat->m2)[3] );
#else
#endif
}
...
void Matrix4x4_projection(Matrix4x4 _mat, float _width, float _height, float _near, float _far)
{
    ...
    _mat->m2 = _mm_setr_ps( 0.0,                   0.0,                   epsilon-1.0,                          -1.0 );
...
void Matrix4x4_from_axis_angle(Matrix4x4 _mat, float3 _axis, float _radian)
{
...
float4 Matrix4x4_mul_float4(Matrix4x4 _mat, float4 _ft)///__m128& point, Matrix4x4& matrix, __m128& result)
{
#ifdef USE_SSE
    ///ALIGN_Value4(__m128, temp0, temp1, temp2, temp3);
    __m128 point = _mm_loadu_ps((float*)_ft);
...
#ifdef USE_SSE
    matrix4x4 mat4exec;
    mat4exec.m0 = _mm_set1_ps(fexec);
    mat4exec.m1 = _mm_set1_ps(fexec);
    mat4exec.m2 = _mm_set1_ps(fexec);
    mat4exec.m3 = _mm_set1_ps(fexec);
