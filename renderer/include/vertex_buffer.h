...
API_EXPORT VertexBuffer _VertexBuffer_new(VertexDecl _dec, const char* _file, uint _line);
API_EXPORT void _VertexBuffer_delete(VertexBuffer _self, const char* _file, uint _line);
...
API_EXPORT uint* VertexBuffer_get_ele_offs(VertexBuffer _self);
#endif
