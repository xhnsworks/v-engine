...
API_EXPORT TextureCube _TextureCube_new(const char* _file, euint _line);
API_EXPORT void _TextureCube_delete(TextureCube _self, const char* _file, euint _line);
...
API_EXPORT void TextureCube_create(TextureCube _self, pixel_format _fmt, euint32 _size);
API_EXPORT euint32 TextureCube_get_id(TextureCube _self);
