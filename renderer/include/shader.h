...
API_EXPORT euint32 Shader_get_id(Shader _sdr);
API_EXPORT void _Shader_load_from_string(const char* _file, euint32 _line, Shader _sdr, const char* _str, shader_type _type);
