...
API_EXPORT void Camera_draw_shape(Camera _self,
                                  struct _line_drawer* _drawer);

API_EXPORT void Camera_set_proj_matrix(Camera _self,
                                       matrix4x4* _mat);
API_EXPORT void Camera_set(Camera _self,
                           bool _is_orthogonal,
                           float _width,
                           float _height,
                           float _near,
                           float _far);
API_EXPORT void Camera_set_proj_scale(Camera _self,
                                      float x_scale,
                                      float y_scale);
...
API_EXPORT void Camera_translate(Camera _self,
                                 float _x,
                                 float _y,
                                 float _z);
API_EXPORT void Camera_rotate(Camera _self,
                              EFloat3 _axis,
                              float _rad);
...
API_EXPORT void Camera_refresh(Camera _self,
                               euint32 _width,
                               euint32 _height);

API_EXPORT EFloat3 FORCE_ALIGN_ARG_POINTER
Camera_screen_position_to_world_position(Camera _self,
                                         float x,
                                         float y);
#endif
