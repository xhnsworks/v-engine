...
{
    _self->base.shader_node_init_proc = BranchNode_Init;
    _self->base.shader_node_dest_proc = BranchNode_Dest;
    _self->base.shader_node_clone_proc = _BranchNode_clone;
    _self->base.compile_proc = BranchNode_compile;
...
BranchNode _BranchNode_clone(BranchNode _bn, const char* _file, uint _line)
{
    BranchNode ret = Malloc(sizeof(branch_node));
    ret->base.shader_node_init_proc = BranchNode_Init;
    ret->base.shader_node_dest_proc = BranchNode_Dest;
    ret->base.shader_node_clone_proc = _BranchNode_clone;
    ret->base.compile_proc = BranchNode_compile;
    branch_block null_brh_blk = {{NULL, EmptyCompare, NULL}, NULL};
...
{
    ShaderNodeBase_delete(_self, __FILE__, __LINE__);
}
