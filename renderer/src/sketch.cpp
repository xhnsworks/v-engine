...
void SketchBookConfig_set_sketch_format(SketchBookConfig _self, euint32 _idx, pixel_format _fmt)
{
    if (_self->sketch_format_array)
    {
...
void SketchBookConfig_set_size(SketchBookConfig _self, euint32 _width, euint32 _height)
{
...
euint32 SketchBookConfig_get_num_sketchs(SketchBookConfig _self)
{
    if (_self->sketch_format_array)
...
euint32 SketchBookConfig_get_width(SketchBookConfig _self)
{
    return _self->width;
}

euint32 SketchBookConfig_get_height(SketchBookConfig _self)
{
    return _self->height;
}

pixel_format SketchBookConfig_get_sketch_format(SketchBookConfig _self, euint32 _idx)
{
...
SketchBook SketchBook_new(SketchBookConfig _cfg)
{
    ...
    euint32 width = SketchBookConfig_get_width(_cfg);
    euint32 height = SketchBookConfig_get_height(_cfg);
    euint32 n = SketchBookConfig_get_num_sketchs(_cfg);
    if (n)
    {
...
void SketchBook_draw_begin(SketchBook _self, euint32 _use_skhs)
{
...
Texture2DPtr SketchBook_get_sketch(SketchBook _self, euint32 _i)
{
...
SketchCube SketchCube_new(euint32 size, pixel_format format)
{
    SketchCube ret;
