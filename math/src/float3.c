...
float Float3_dot(float3 _f3_0, float3 _f3_1)
{
    ...
    f3_1.float3 = _f3_1;
  #ifdef DEBUG
    EAssert(f3_0.ref_ptr % 16 == 0, "float3 error");
    EAssert(f3_1.ref_ptr % 16 == 0, "float3 error");

    EAssert(f3_0.float128[3] == 0.0f, "float3 error");
    EAssert(f3_1.float128[3] == 0.0f, "float3 error");
  #endif
...
float3 Float3_mul_float(float _ft, float3 _f3)
{
    ...
    f3.float3 = _f3;
  #ifdef DEBUG
    EAssert(f3.ref_ptr % 16 == 0, "float3 error");
    EAssert(f3.float128[3] == 0.0f, "float3 error");
  #endif
