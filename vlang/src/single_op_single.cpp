...
static result_type_table s_result_type_table[] =
{
    ...
    {IntValue,       {IntValue,     IntValue,     UnknownValue, UnknownValue, UnknownValue, UnknownValue,   UnknownValue, UnknownValue, UnknownValue}},
    {FloatValue,     {FloatValue,   FloatValue,   UnknownValue, UnknownValue, UnknownValue, UnknownValue,   UnknownValue, UnknownValue, UnknownValue}},
    {Float2Value,    {UnknownValue, UnknownValue, UnknownValue, UnknownValue, UnknownValue, UnknownValue,   UnknownValue, UnknownValue, UnknownValue}},
    {Float3Value,    {UnknownValue, UnknownValue, UnknownValue, UnknownValue, UnknownValue, UnknownValue,   UnknownValue, UnknownValue, UnknownValue}},
    {Float4Value,    {UnknownValue, UnknownValue, UnknownValue, UnknownValue, UnknownValue, UnknownValue,   UnknownValue, UnknownValue, UnknownValue}},
    {Matrix4x4Value, {UnknownValue, UnknownValue, UnknownValue, UnknownValue, UnknownValue, UnknownValue,   UnknownValue, UnknownValue, UnknownValue}},
    {StringValue,    {UnknownValue, UnknownValue, UnknownValue, UnknownValue, UnknownValue, UnknownValue,   UnknownValue, UnknownValue, UnknownValue}},
    {BoolValue,      {UnknownValue, UnknownValue, UnknownValue, UnknownValue, UnknownValue, UnknownValue,   UnknownValue, UnknownValue, UnknownValue}},
    {Function,       {UnknownValue, UnknownValue, UnknownValue, UnknownValue, UnknownValue, UnknownValue,   UnknownValue, UnknownValue, UnknownValue}},
};
...
CommandClosures SingleSymbolOperator2(ParserEnv* e, OperatorType op, SymbolValue dst, SymbolValue src)
{
    ...
    case Function:
        ...
        ret.data.mem_addr.offs = ValueAllocator_alloc(&e->vari_alloc, (ValueType)ret.type);
        break;
    case StringValue:
        ret.data.mem_addr.mem_type = VariStrMem;
        ret.data.mem_addr.offs = ValueAllocator_alloc(&e->vari_str_alloc, (ValueType)ret.type);
        break;
    default:
